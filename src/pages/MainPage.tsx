        ...
        <div className="flex h-4/5 items-stretch justify-center align-center space-x-6 px-10 mb-10">
            <div className="flex flex-col shadow-lg h-full justify-evenly items-center whitespace-normal rounded-md px-3 py-2">
                <div className="w-[350px] h-[350px] mb-10">
                    <img src="/SafeEyes/public/ppe.png" alt="" className="w-full h-full object-fill rounded-lg" />
                </div>
            ...
            <div className="flex flex-col shadow-lg h-full justify-evenly items-center whitespace-normal rounded-md px-3 py-2">
                <div className="w-[350px] h-[350px] mb-10"><img src="/SafeEyes/public/fires.png" alt="" className="w-full h-full object-fill rounded-lg"/></div>
            ...
            <div className="flex flex-col shadow-lg h-full justify-evenly items-center whitespace-normal rounded-md px-3 py-2">
                <div className="w-[400px] h-[350px] mb-10"><img src="/SafeEyes/public/performances.png" alt="" className="w-full h-full object-fill rounded-lg"/></div>
